...
<body class="gray_bg2 m-0 p-0">
    ...
    <div class="container-fluid m-0 p-0 gradient_pink2">
        <!-- title and intro -->
        <div class="container p-4 center_align">
        ...
        <div class="container-fluid m-0 p-3 how_app_work gray_bg">
            ...
            <div class="row center_align py-4 px-5 m-0 gx-5 how_app_work">
                <div class="col-sm-3">
    ...
    <!-- monthly theme -->
    <div class="container-fluid m-0 p-4 gradient_blue_orange_red">
        <div class="container">
