...
<head>
    ...
    <title>Monthly Theme</title>
    <?php include 'head_resource.php';?>
    <link rel="stylesheet" href="css/month_theme.css">
</head>
<body class="gray_bg">
    <!-- navigation bar -->
                        ...
                        <div class="col-sm-4 img_style p-2">
                            <div class="card rounded-1 border-1 m-0 p-0 overflow-hidden">
                                <div class="card-body price_card mb-0">
                                    ...
                                    <h6 class="card-title month_title mt-2">Includes..</h6>
                                </div>
                                <div class="card-body pink_btn2 mt-0 p-2">
                                    <div class="col-sm-12 p-0 pink_btn pb-3 mb-3 btn_text">
                                        <a class="text-decoration-none"><button class="btn btn-dark border-0 px-4 shadow rounded-1" type="button">Add to Card</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="container-fluid m-0 p-0 bg-light py-5 bg-dark text-light">
        <div class="container text-center">
            ...
            <div class="col-sm-12 p-0 pink_btn pt-15">
                <h2 class="bold_header 2 pb-4">Until the <strong>UKAY TAMIS Summer Fest Box</strong> deadline</h2>
                <a href="subscription_price.php" class="text-decoration-none">
                    <button class="btn btn-dark border-0 px-5 py-3 shadow rounded-lg" type="button" style="font-size: 18px;">SUBSCRIBE NOW</button>
                </a>
            </div>
...
<script>
    ...
    var x = setInterval(function() {
        ...
        var distance = endOfMonth.getTime() - now;
